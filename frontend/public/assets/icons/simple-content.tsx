...
interface SimpleContentIconProps {
  className?: string;
  width?: number;
  height?: number;
}

const SimpleContentIcon = ({ className, width = 16, height = 16 }: SimpleContentIconProps) => {
  return (
    <svg
      width={width}
      height={height}
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M7 6H5c-.553 0-1-.447-1-1s.447-1 1-1h2c.553 0 1 .447 1 1s-.447 1-1 1zM7 14H5c-.553 0-1-.447-1-1s.447-1 1-1h2c.553 0 1 .447 1 1s-.447 1-1 1zM7 10H5c-.553 0-1-.447-1-1s.447-1 1-1h2c.553 0 1 .447 1 1s-.447 1-1 1z"
      />
    </svg>
  );
};

export { SimpleContentIcon };
